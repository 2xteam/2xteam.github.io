...
const OrderForm = ({ onPostCode, formValue, onChange, errors }) => {
  const { receiver, receiver_phone_number, address, address2, address3, address_message } =
    formValue;
    ...
    <OrderFormWrapper>
      ...
      <Form>
        ...
        <DefaultTextWrapper>
          ...
          <input type="text" name="receiver" id="receiver" value={receiver} onChange={onChange} />
        ...
        <DefaultTextWrapper>
          ...
          <input
            ...
            onChange={onChange}
          />
          {errors.receiver_phone_number && <span>{errors.receiver_phone_number}</span>}
        </DefaultTextWrapper>
        <PostTextWrapper>
        ...
        <DefaultTextWrapper className="post-message">
          ...
          <input type="text" value={address_message} name="address_message" onChange={onChange} />
